...
>(({ className, sideOffset = 8, ...rest }, forwardedRef) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 w-[300px] overflow-hidden rounded-xl border border-stroke-soft-200 bg-bg-white-0 p-1.5 shadow-overlay',
        'flex flex-col gap-1',
        // origin
...
>(({ className, ...rest }, forwardedRef) => (
  <DropdownMenuPrimitive.SubContent
    ref={forwardedRef}
    className={cn(
      'z-50 w-max overflow-hidden rounded-xl border border-stroke-soft-200 bg-bg-white-0 p-1.5 shadow-overlay',
      'flex flex-col gap-1',
      // animation
      'data-[state=open]:animate-in data-[state=open]:fade-in-0',
      'data-[state=closed]:animate-out data-[state=closed]:fade-out-0',
